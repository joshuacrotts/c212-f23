...
public class PrimNode extends AstNode {
    ...
    public PrimNode(String op, List<AstNode> operands) {
        super();
        this.OP = op;
        this.getChildren().addAll(operands);
    }
    ...
    public static boolean isPrim(String id) {
        return id.equals("+")||id.equals("-")||id.equals("*")||id.equals("eq?");
    }
}
