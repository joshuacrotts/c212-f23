...
final class Environment extends HashMap<String, AstNode> {
     ...
     * @param v AstNode to bind.
     * @return new Environment containing old bindings and the new binding.
     */
     ...
     * @return new Environment containing old bindings and the new bindings.
     */
